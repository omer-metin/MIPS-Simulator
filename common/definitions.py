...
instruction_machinecode_orders = dict([
    ...
    (_bne,      {opc: 0b000_101}),
    (_lb,       {opc: 0b100_000, rs: 0}),
    (_lbu,      {opc: 0b100_100, rs: 0}),
    (_lh,       {opc: 0b100_001, rs: 0}),
    (_lhu,      {opc: 0b100_101, rs: 0}),
    (_lui,      {opc: 0b001_111, rs: 0}),
    (_lw,       {opc: 0b100_011, rs: 0}),
    (_lwc1,     {opc: 0b110_001, rs: 0}),
    (_ori,      {opc: 0b001_101}),
